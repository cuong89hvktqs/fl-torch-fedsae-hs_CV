...
class Dataset:
    def __init__(self, args):
        ...
        self.mal_dataset = self.load_mal_dataset()
    ...
    def get_mal_dataset(self):
        """
        Returns the mal dataset.

        :return: tuple
        """
        return self.mal_dataset
    ...
    def load_val_dataset(self):
        """
        Loads & returns the validation dataset.

        :return: tuple
        """
        raise NotImplementedError("load_val_dataset() isn't implemented")
    ...
    def load_mal_dataset(self):
        """
        Loads & returns the mal dataset.

        :return: tuple
        """
        raise NotImplementedError("load_mal_dataset() isn't implemented")
    ...
    def get_val_loader(self, batch_size, **kwargs):
        """
        Return the data loader for the val dataset.

        :param batch_size: batch size of data loader
        :type batch_size: int
        :return: torch.utils.data.DataLoader
        """
        return Dataset.get_data_loader_from_data(batch_size, self.val_dataset[0], self.val_dataset[1], **kwargs)
    ...
    def get_mal_loader(self, batch_size, **kwargs):
        """
        Return the data loader for the mal dataset.

        :param batch_size: batch size of data loader
        :type batch_size: int
        :return: torch.utils.data.DataLoader
        """
        return Dataset.get_data_loader_from_data(batch_size, self.mal_dataset[0], self.mal_dataset[1], **kwargs)
